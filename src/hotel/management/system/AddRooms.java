...
public class AddRooms extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==b1)
        {
            ...
            int roomNumber = 0;
            try{
                 roomNumber=Integer.parseInt(t1.getText());
                 flag=1;
            }   
            catch(Exception e)
            {
            ...
            if(flag==1)
            {
                room=Integer.toString(roomNumber);
            }
            ...
            int priceNumber = 0;
            try{
                 priceNumber=Integer.parseInt(t2.getText());
                 flag1=1;
            }   
            catch(Exception e)
            {
            ...
            if(flag1==1)
            {
                price=Integer.toString(roomNumber);
            }
            ...
            try
            {
                ...
                JOptionPane.showMessageDialog(null,"Successfully New Room Created");
